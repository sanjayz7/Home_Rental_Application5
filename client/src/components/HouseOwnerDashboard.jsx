...
const HouseOwnerDashboard = () => {
  ...
  const loadDashboardData = async () => {
    try {
      ...
      // Load property requests from localStorage
      ...
      setPropertyRequests(ownerRequests);
      ...
      setStats({
        ...
        pendingBookings,
        totalRevenue,
        totalRequests: ownerRequests.length
      });
    } catch (error) {
      ...
      <Container>
          ...
          <Col xl={3} lg={6} md={6} className="mb-3">
            <Card className="stats-card h-100">
              <Card.Body className="text-center">
                ...
                <h3 className="text-warning">{stats.totalRequests || 0}</h3>
        ...
        <Card className="table-container mb-4">
          <Card.Header className="d-flex justify-content-between align-items-center bg-info text-white">
            <h5 className="mb-0"><i className="fas fa-envelope me-2"></i>Property Inquiries</h5>
            <Badge bg="light" text="dark">{propertyRequests.length} requests</Badge>
          </Card.Header>
          <Card.Body>
            <div className="table-responsive">
              <Table hover>
                    ...
                    <tr>
                      <td colSpan="5" className="text-center py-4">
                        <div className="text-muted">
                          ...
                          <p className="small">When users request information about your properties, they'll appear here</p>
                        </div>
                      </td>
                    </tr>
                  ) : (
                      ...
                      <tr key={index}>
                        ...
                        <td>
                          <div>
                            ...
                            <br />
                            <small className="text-muted">ID: {request.listingId}</small>
                          </div>
                        </td>
                        <td>
                          <div>
                        ...
                        <td>
                          <div className="d-flex gap-1">
                            <Button 
                              as="a"
                              href={`mailto:${request.userEmail}?subject=Re: ${request.propertyTitle}&body=Hi ${request.userName},%0D%0A%0D%0AThank you for your inquiry about ${request.propertyTitle}.%0D%0A%0D%0A`}
                              variant="outline-primary" 
                              size="sm"
